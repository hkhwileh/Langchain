...
def scrape_user_tweets(username, num_tweets=5 , mock:bool = False):
    """
    Hello this is new method for scraping the tweets from the twitter
    """
    """
    ...
    if mock:
        ...
        for tweet in tweets:
            ...
            tweets_dict["url"]= f"https://twitter.com/{username}/status/{tweet['id']}"
            tweet_list.append(tweets_dict)
    else:
